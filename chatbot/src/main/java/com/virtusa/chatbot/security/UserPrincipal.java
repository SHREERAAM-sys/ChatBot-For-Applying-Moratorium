...
public class UserPrincipal implements OAuth2User, UserDetails{
    ...
    public static UserPrincipal create(ClientRegistrationModel user) {
    ...
    public static UserPrincipal create(ClientRegistrationModel user, Map<String, Object> attributes) {
